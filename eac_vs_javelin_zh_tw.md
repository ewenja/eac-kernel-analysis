...
- EAC 側（都在本資料夾）：[eos_driver_analysis_zh_tw.md](eos_driver_analysis_zh_tw.md)、
  [SOURCES.md](SOURCES.md)、
  [eos_sys_2026_05_static_revalidation.md](eos_sys_2026_05_static_revalidation.md)
- Javelin 側：在另一個資料夾 `ea-javelin-anticheat`（本資料夾刻意不連結），
  檔案是該資料夾的 `javelin_analysis_zh_tw.md` 與 `SOURCES.md`
- 前置研究：同樣在 `ea-javelin-anticheat` 的 `SOURCES.md`
